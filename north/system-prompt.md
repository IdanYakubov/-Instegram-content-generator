...
> The Compass app has been renamed to **North**. This file holds the current system prompt for the North AI persona, kept here for reference until it can be wired into the actual Compass/North application repo.
